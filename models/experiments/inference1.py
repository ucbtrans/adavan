...
INPUT_VIDEO_PATH = 'step1_output/22-10-2025_17-48-39.mp4' # Replace with the actual video file path
OUTPUT_VIDEO_PATH = 'step1_output/22-10-2025_17-48-39.avi' # 'step1_output/22-10-2025_17-48-39.avi' # 'annotated_output_parallel.avi'
...
if __name__ == "__main__":
    ...
    INPUT_VIDEO_SOURCE = INPUT_VIDEO_PATH 
